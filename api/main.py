...
/* Light theme — switch via [data-theme="light"] on html */
[data-theme="light"]{--bg0:#f5f7fa;--bg1:#eef1f5;--bg2:#e4e8ee;--line:rgba(0,0,0,.08);--line-hover:rgba(125,211,252,.4);--muted:rgba(0,0,0,.45);--text:rgba(0,0,0,.85);--accent:#0ea5e9;--accent-dim:rgba(14,165,233,.1);--card-bg:rgba(255,255,255,.7);--card-hover:rgba(14,165,233,.06)}
/* Smooth transition on theme change */
*,*::before,*::after{transition:background .2s ease,border-color .2s ease,color .15s ease,box-shadow .2s ease}
...
.theme-toggle{font-size:16px;cursor:pointer;padding:6px;border-radius:50%;border:1px solid var(--line);width:32px;height:32px;display:inline-flex;align-items:center;justify-content:center;transition:all .25s;margin-right:4px;user-select:none;background:rgba(255,255,255,.03)}
.theme-toggle:hover{border-color:var(--line-hover);background:var(--card-hover);transform:rotate(12deg)}
...
def page_landing() -> str:
    return f"""<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>VisePanda — AI China Travel Planner 🇨🇳</title><meta name="description" content="Plan your China trip with AI. Get personalized itineraries, local food recommendations, hotel tips. Beijing, Shanghai, Chengdu, Yunnan — tell us where and how long."><meta property="og:title" content="VisePanda — AI China Travel Planner"><meta property="og:description" content="Personalized China travel itineraries powered by AI"><meta property="og:type" content="website"><meta name="twitter:card" content="summary">{_font_links()}<style>{CSS}</style>{_inject_config()}<script>var t=localStorage.getItem("vp_theme")||(window.matchMedia("(prefers-color-scheme:light)").matches?"light":"dark");document.documentElement.setAttribute("data-theme",t);document.addEventListener("DOMContentLoaded",function(){{var e=document.querySelector(".theme-toggle");if(e)e.textContent=t==="light"?"🌙":"☀️"}})</script><script>navigator.serviceWorker&&navigator.serviceWorker.register("/sw.js")</script></head><body>
<div class="bg-shanshui"></div>
<div class="bg-glow"></div>
<header><a href="/" class="brand"><span class="brand-logo"></span><span class="brand-name">VisePanda</span></a><div id="authArea"><span class="theme-toggle" onclick="var d=document.documentElement;var t=d.getAttribute('data-theme')==='light'?'dark':'light';d.setAttribute('data-theme',t);localStorage.setItem('vp_theme',t);this.textContent=t==='light'?'🌙':'☀️'">🌙</span><a href="#" onclick="event.preventDefault();signIn()" class="btn btn-accent">Sign in</a></div></header>
<div class="hero">
...
</style><script>var t=localStorage.getItem("vp_theme")||(window.matchMedia("(prefers-color-scheme:light)").matches?"light":"dark");document.documentElement.setAttribute("data-theme",t);document.addEventListener("DOMContentLoaded",function(){{var e=document.querySelector(".theme-toggle");if(e)e.textContent=t==="light"?"🌙":"☀️"}})</script><script>navigator.serviceWorker&&navigator.serviceWorker.register("/sw.js")</script></head><body>
<div class="bg-shanshui"></div>
<header><a href="/" class="brand"><span class="brand-logo"></span><span class="brand-name">VisePanda</span></a><div><span class="theme-toggle" onclick="var d=document.documentElement;var t=d.getAttribute('data-theme')==='light'?'dark':'light';d.setAttribute('data-theme',t);localStorage.setItem('vp_theme',t);this.textContent=t==='light'?'🌙':'☀️'">🌙</span><a href="/" class="btn">Home</a></div></header>
...
</style><script defer src='/_vercel/insights/script.js'></script><script defer src='/_vercel/speed-insights/script.js'></script>{_inject_config()}<script>var t=localStorage.getItem("vp_theme")||(window.matchMedia("(prefers-color-scheme:light)").matches?"light":"dark");document.documentElement.setAttribute("data-theme",t);document.addEventListener("DOMContentLoaded",function(){{var e=document.querySelector(".theme-toggle");if(e)e.textContent=t==="light"?"🌙":"☀️"}})</script><script>navigator.serviceWorker&&navigator.serviceWorker.register("/sw.js")</script></head><body>
<div class="bg-shanshui"></div>
<header><a href="/" class="brand"><span class="brand-logo"></span><span class="brand-name">VisePanda</span></a><div><span class="theme-toggle" onclick="var d=document.documentElement;var t=d.getAttribute('data-theme')==='light'?'dark':'light';d.setAttribute('data-theme',t);localStorage.setItem('vp_theme',t);this.textContent=t==='light'?'🌙':'☀️'">🌙</span><a href="/trips" class="btn" style="margin-right:8px">Trips</a><a href="#" onclick="event.preventDefault();clearChat()" class="btn" style="margin-right:8px">Clear</a><a href="/" class="btn">Home</a></div></header>
