...
- Tools/Explore placeholder copy in `strings.xml` now reads v0.3.7/v0.3.8 respectively (renumbered from v0.3.6/v0.3.7 now that Butler occupies v0.3.6) — keep these two in sync whenever a version renumbering happens again.
