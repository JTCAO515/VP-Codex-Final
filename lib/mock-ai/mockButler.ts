      ...
      blocks: [
        {
          ...
          description: "Settle near Dongcheng or Wangfujing for easy metro access.",
        },
        {
          time: "Afternoon",
          title: "Temple of Heaven",
          description: "A graceful first stop with open space and manageable walking.",
        },
      ],
      food: ["Hutong noodles", "Simple roast duck dinner"],
      stay: "Dongcheng or Wangfujing",
      transport: "Use short taxi rides or metro after check-in.",
      note: "Keep the first day gentle after the flight.",
      status: "new",
    },
  ],
  alerts: [
