...
const ENVIRONMENT_KEYS: Array<{ key: string; purpose: string }> = [
  ...
  { key: "QWEN_CHAT_MODEL", purpose: "Optional Butler chat model for Qwen/DashScope, defaults to qwen-plus" },
  ...
  { key: "ZHIPU_CHAT_MODEL", purpose: "Optional Zhipu model override, defaults to glm-4-plus" },
  ...
  { key: "MOONSHOT_CHAT_MODEL", purpose: "Optional Moonshot model override, defaults to moonshot-v1-128k" },
