...
依次完成三轮迭代(v0.2.6 → v0.2.7 → v0.2.8),每轮独立提交、可独立上线。
...
- 当前版本 v0.2.5;仓库根目录 `CLAUDE.md` 是项目记忆,先读它。
...
### 第 3 轮 = v0.2.8 「设计系统收口 + Tools 交互组件」
...
- v0.2.6:点"减负"→ 3s 内对应 Day 卡脉冲、摘要卡列出改动、完成度动画;
  点摘要条目画布定位;点撤销恢复上一版。
- v0.2.7:问 "Do I need a visa?" 秒出工具卡并可加入提醒;任何发送 100ms
  内有可见反馈;悬停摘要条目画布亮卡。
- v0.2.8:三个工具双端可完成真实任务;新组件 ≥3 页复用无样式漂移。
