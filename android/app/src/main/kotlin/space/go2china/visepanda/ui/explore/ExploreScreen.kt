...
/**
 * v0.3.14: mock-first Explore (operator directive, /goal Phase 1) — city
 * filter, 3 POI sections (Attractions/Food/Stay), and "Add to Trip" writing
 * directly into the active trip via [space.go2china.visepanda.data.repository.TripRepository.addPoiToDay].
 * No real Amap/POI API call is made (out of scope per the same directive).
 */
